...
class UserKey(Command):
    ...
    @staticmethod
    def _add(card: cryptnox_sdk_py.Card, auth_type: str, description: str = "") -> int:
        result = -1
    ...
    @staticmethod
    def _delete(card: cryptnox_sdk_py.Card, auth_type: str) -> int:
        result = -1
    ...
    def _list(self, card: cryptnox_sdk_py.Card) -> int:
