...
def get_init_data(card: cryptnoxpy.card, demo: bool = False) -> InitData:
    if demo and not confirm("Do you wish to proceed?",
                            "WARNING: THIS WILL INITIALIZE THE CARD IN DEMO MODE"):
        raise ExitException()
    ...
    if demo:
        init_data = InitData("DEMO", "DEMO", security.DEMO_PIN, security.demo_puk(card))
        data = [
